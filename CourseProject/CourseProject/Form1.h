...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Text = L"ƒÓ·‡‚ËÚ¸ ÁÌ‡˜ÂÌËÂ";
			...
			this->button2->Text = L"”‰‡ÎËÚ¸ ÁÌ‡˜ÂÌËÂ";
			...
			this->button3->Text = L"Õ‡ÈÚË ÁÌ‡˜ÂÌËÂ";
			...
			this->button5->Text = L"ŒÚÒÓÚËÓ‚‡Ú¸ Ï‡ÒÒË‚";
			...
			this->button6->Text = L"«‡ÔÓÎÌËÚ¸ Ï‡ÒÒË‚ Ò ‡ÁÏÂÓÏ";
			...
			series1->Name = L"¡ËÌ‡ÌÓÂ ‰ÂÂ‚Ó ÔÓËÒÍ‡";
			series2->ChartArea = L"ChartArea1";
			series2->ChartType = System::Windows::Forms::DataVisualization::Charting::SeriesChartType::Line;
			series2->Legend = L"Legend1";
			series2->Name = L"—ÓÚËÓ‚Í‡ ÔˇÏ˚Ï Ó·ÏÂÌÓÏ";
			...
			this->Name = L"Form1";
			this->Text = L"¡ËÌ‡ÌÓÂ ‰ÂÂ‚Ó ÔÓËÒÍ‡";
